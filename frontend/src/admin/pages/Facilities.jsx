  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        title: "Gagal",
        text:
          err.response?.data?.message || "Fasilitas gagal ditambahkan",
        confirmButtonColor: "#dc2626",
      });
    } finally {
      setSaving(false);
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <p className="text-sm font-medium text-red-600 mb-2">Admin Panel</p>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative" ref={dropdownRef}>
                    <button
                      ...
                      className="w-full flex items-center justify-between rounded-2xl border border-gray-300 bg-gray-50 px-4 py-3 outline-none hover:border-red-400 focus:ring-2 focus:ring-red-500"
                    >
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="w-full bg-red-600 text-white py-3.5 rounded-2xl font-semibold hover:bg-red-700 transition disabled:opacity-70"
                >
